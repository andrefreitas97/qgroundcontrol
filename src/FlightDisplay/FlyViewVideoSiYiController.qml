...
Rectangle {
    ...
    MouseArea {
        ...
        anchors.fill: parent
        hoverEnabled: false
        visible: false //camera.isConnected //false
        onPressed: {
    ...
    Item {
        ...
        Column {
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: downMA.pressed ? "qrc:/resources/SiYi/DownGreen.svg" : "qrc:/resources/SiYi/Down.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
                ...
                MouseArea {
                    id: downMA
                    anchors.fill: parent
                    onPressed: camera.sendControlAngle()
                }
            }
