...
DECLARE_SETTINGSFACT(VideoSettings, colorPalette)
DECLARE_SETTINGSFACT(VideoSettings, tempFullImage)
DECLARE_SETTINGSFACT(VideoSettings, pointTemp)
DECLARE_SETTINGSFACT(VideoSettings, thermalGain)
DECLARE_SETTINGSFACT(VideoSettings, gimbalMode)
DECLARE_SETTINGSFACT(VideoSettings, zt6ImageMode)
DECLARE_SETTINGSFACT(VideoSettings, gridLines)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_FPV)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_GimbalA8)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_GimbalZT6Main)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_GimbalZT6Sub)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_GimbalZIO)
DECLARE_SETTINGSFACT(VideoSettings, videoFlip_Celera)
...
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlFPV)
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlA8)
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlZT6Main)
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlZT6Sub)
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlZIO)
DECLARE_SETTINGSFACT(VideoSettings, rtspUrlCelera)
