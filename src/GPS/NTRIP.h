...
signals:
    ...
    // Emitted when SPARTN corrections are received from the NTRIPTCPLink.
    // These corrections are forwarded to the connected vehicle using the same RTCM forwarding path elsewhere in the code.    
